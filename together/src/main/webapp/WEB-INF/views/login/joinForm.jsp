			...
			<section class="ftco-section">
				<div class="container">
					...
					<div class="col-md-6 order-md-last pr-md-5 padding_r15" style="padding-right: 15px !important;">
						...
						<form name="inputForm" action="${ pageContext.request.contextPath }/login/join" method="post">
	  ...
	  <div class="modal-dialog" role="document">
	    <div class="modal-content toConf_popup">
	      <div class="modal-header">
	        <h5 class="modal-title toConf_title" id="exampleModalLabel">가입을 축하드립니다</h5>
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
	          <span aria-hidden="true">&times;</span>
	        </button>
	      </div>
	      <div class="modal-body toConf_body">
	      	회원가입이 성공적으로 되었습니다<br>
	      	로그인을 하시겠습니까?
	      </div>
	      <div class="modal-footer">
	        <button type="button" class="btn-secondary conf_btn conf_c " id="main">취소</button>
	        <button type="button" class="btn-primary conf_btn " id="login">로그인</button>
	      </div>
	    </div>
	  </div><!-- // end 부트스트랩 컨펌 창 -->
