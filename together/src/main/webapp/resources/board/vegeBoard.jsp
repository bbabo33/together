								...
								<div class="board_all_div">
									...
									<div class="board_list">
										<table class="list">
											...
											<tr>
												<td>3</td>
												<td><a href="${ pageContext.request.contextPath }/resources/board/vegeBoard_detail.jsp"> 안녕하세요 </a></td>
												<td>KDH</td>
												<td>2018-12-19</td>
											</tr>
											<tr>
											...
											<tr>
												<td>1</td>
												<td><a href="${ pageContext.request.contextPath }/resources/board/vegeBoard_detail.jsp"> 안녕하세요 서울사는
														남자에요 </a></td>
												<td>KDH</td>
												<td>2018-12-17</td>
											</tr>
